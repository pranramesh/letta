...
def _run_schema_test(
    ...
    expect_structured_output_fail: bool = False,
):
    ...
    with open(
        os.path.join(
            ...
            f"test_tool_schema_parsing_files/{schema_name}.py",
        ),
        "r",
    ) as file:
    ...
    with open(
        os.path.join(
            os.path.dirname(__file__),
            f"test_tool_schema_parsing_files/{schema_name}.json",
        ),
        "r",
    ) as file:
    ...
    if expect_structured_output_fail:
        ...
        with open(
            os.path.join(
                os.path.dirname(__file__),
                f"test_tool_schema_parsing_files/{schema_name}_so.json",
            ),
            "r",
        ) as file:
...
def _openai_payload(test_config):
    ...
    try:
        ...
        with open(
            os.path.join(
                os.path.dirname(__file__),
                f"test_tool_schema_parsing_files/{filename}.py",
            ),
            "r",
        ) as file:
            source_code = file.read()
