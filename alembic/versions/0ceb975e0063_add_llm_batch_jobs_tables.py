...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            letta.orm.custom_columns.CreateBatchResponseColumn(),
            nullable=False,
        ),
        sa.Column(
            "latest_polling_response",
            letta.orm.custom_columns.PollBatchResponseColumn(),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "step_state",
            letta.orm.custom_columns.AgentStepStateColumn(),
            nullable=False,
        ),
        sa.Column(
            "batch_request_result",
            letta.orm.custom_columns.BatchRequestResultColumn(),
            nullable=True,
        ),
        sa.Column(
            "created_at",
